export const Checkbox = ({ checked, name = "completed" }: { checked?: boolean; name?: string }) => {
    return (
        <label class="flex justify-center items-center">
            <input class="peer cursor-pointer hidden after:opacity-100" type="checkbox" name={name} checked={checked} />
